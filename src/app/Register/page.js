    ...
    <main className="flex flex-col items-center justify-center flex-1 w-full px-20 text-center">
        ...
        <div className="w-2/5 px-12 text-white bg-orange-500 rounded-tr-2xl rounded-br-2xl py-36">
            ...
            <div className="w-3/5 p-5">
                ...
                <div className="py-10">
                    <h2 className="mb-2 text-3xl font-bold text-orange-500">Sign in to Account</h2>
                    <div className="inline-block w-10 mb-2 border-2 border-orange-500"></div>
                    <div className="flex justify-center my-2">
                        <Link href="#" className="p-3 mx-1 border-2 border-gray-200 rounded-full">
                    ...
                    <div className="flex flex-col items-center mb-3">
                        ...
                        <Link href="#" className="inline-block px-12 py-2 font-semibold text-orange-500 border-2 border-orange-500 rounded-full hover:bg-orange-500 hover:text-white">Sign In</Link>
                    </div>
                </div>
