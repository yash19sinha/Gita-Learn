    ...
    try {
      ...
      if (userSnapshot.exists()) {
        ...
        await setDoc(userRef, {
          ...
          photoURL: photoURL, // Add photoURL to user document
          email: email, // Add email to user document
          authMethod: 'google',
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  className="p-2 block w-full rounded-md border-0 py-1.5  shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6 bg-white"
                />
              </div>
            </div>
